...
This chapter provides context for the major themes of this dissertation. Section \ref{section:intro_crn} introduces the basic theoretical concepts behind computational modeling of chemical reaction networks. Section \ref{section:intro_oscillators} seeks to explain the interest in oscillators by describing their history, dynamics, and biological relevance. Finally, section \ref{section:intro_GA} provides a brief introduction to evolutionary algorithms, their use in systems biology, and current tools for evolutionary computation. 
...
\subsection{Maybe a short thing about this research and oscillators?}
