...
\end{center}
\vspace*{\fill}
Evolutionary algorithms have emerged as powerful tools for the optimization of complex systems, including the evolution of mass-action chemical reaction networks. This dissertation delves into the efficacy of evolutionary algorithms in this domain, presenting a novel approach inspired by neural network evolution methodologies. The algorithm demonstrates remarkable effectiveness of separating candidate reaction networks into species based on their similarity, which maintains diversity and protects innovations. Crossover has also been shown to be an effective means of improving evolutionary success in other domains. Here, crossover of mass-action networks is tested and found to be detrimental to the evolutionary process. Other factors influencing evolutionary success are also explored and optimized resulting in a 10-fold improvement over previous algorithms. This work goes beyond theoretical exploration by offering a practical contribution in the form of a user-friendly software module. This module encapsulates the newly devised algorithm, empowering researchers and practitioners to readily apply the speciation-based approach in their own investigations of mass-action chemical reaction networks.
...
The study of modern non-linear dynamics began with Boris Pavlovich Belousov, who was in search of an inorganic analog of the Krebs cycle. He investigated a solution of bromate, citric acid, and ceric ions. To his surprise, the solution repeatedly altered between clear and yellow in color. After thoroughly studying the system, he submitted the results as a manuscript, which was promptly rejected as the ``supposed discovered discovery" was impossible. He spent six more yesrs revising the manuscript before abandoning the work \cite{epstein_introduction_1998}.

In 1961, a graduate student, Anatol Zhabotinksy, began to examine the system, replacing some ingredients. In 1968 Zhabotinksy presented their results which led to the extensive study of the Belousov-Zhabotinksy (BZ) reaction. The scientific community continued to dispute the existence of a homogenous oscillator, leading to much discussion and study of the subject \cite{epstein_design_1984}.
...
\subsection{NOte about top network for species fitness and specation}
In the 

\subsection{Evolving Oscillators with Optimal Settings}
The experiments described above l
...
The adapted evolutionary algorithm is packaged in a julia module, NetEvolve, for easy use and customization. Compared to previous attempts to develop evolutionary algorithms for mass-action networks, NetEvolve has a considerably higher success rate and better performance.
