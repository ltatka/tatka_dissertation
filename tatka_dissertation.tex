...
More recently, in 2020, Gad introduced the python package pyGAD for optimization using genetic algorithms \cite{gad2023pygad}. Like DEAP pyGAD offers users a range of genetic operators, algorithms, and objective functions. PyGAD aims to offer a more user friendly form of DEAP with additional capabilities such as built in visualization tools and more adaptable mutation.
